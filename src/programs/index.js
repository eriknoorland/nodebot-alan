...
const testPrograms = [
  ...
  { name: '[Test] 1m heading', module: testHeading(1000) },
  { name: '[Test] 2m heading', module: testHeading(2000) },
  { name: '[Test] 3m heading', module: testHeading(3000) },
  ...
  { name: '[Test] Rechte lijn 1m CW', module: testStraightLine(1000) },
  { name: '[Test] Rechte lijn 2m CW', module: testStraightLine(2000) },
  { name: '[Test] Rechte lijn 3m CW', module: testStraightLine(3000) },
  { name: '[Test] Rechte lijn 4m CW', module: testStraightLine(4000) },
  { name: '[Test] Rechte lijn 1m CCW', module: testStraightLine(1000, -1) },
  { name: '[Test] Rechte lijn 2m CCW', module: testStraightLine(2000, -1) },
  { name: '[Test] Rechte lijn 3m CCW', module: testStraightLine(3000, -1) },
  { name: '[Test] Rechte lijn 4m CCW', module: testStraightLine(4000, -1) },
