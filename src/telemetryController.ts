import { Data as LineSensorData } from '@eriknoorland/nodebot-line-sensor/dist/dts/interfaces'
import { IConfig } from './config';

export default (socket, config: IConfig, sensors, missions) => {
  ...
  function onLineData(data: LineSensorData) {
    lineData = [...data];
  }
  ...
  function setFps() {
    ...
    fps.actual = 1000 / (currentTimestamp.getTime() - lastTimestamp.getTime());
